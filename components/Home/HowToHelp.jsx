...
const HowToHelp = () => {
  ...
  return (
    <Grid container sx={{ maxWidth: "850px", width: "100%", margin: "2.4rem auto 1.2rem", justifyContent: "center", textAlign: "center" }}>
      <Grid item xs={12}>
      ...
      <Grid item xs={12} sm={6} mt={2} sx={{ paddingRight: { xs: 0, sm: 4 } }}>
        <Box sx={{ display: "flex", flexDirection: "column", justifyContent: "space-between", height: "100%" }}>
          ...
          <Link href='/donate'>
            <Button variant='contained' color='secondary' startIcon={<Favorite />} sx={{ mt: 2 }}>
      ...
      <Grid item xs={12} sm={6} mt={{ xs: 4, sm: 2 }} sx={{ paddingLeft: { xs: 0, sm: 4 } }}>
        <Box sx={{ display: "flex", flexDirection: "column", justifyContent: "space-between", height: "100%" }}>
          ...
          <Link href='/volunteers'>
            <Button variant='contained' color='secondary' startIcon={<VolunteerActivism />} sx={{ mt: 2 }}>
